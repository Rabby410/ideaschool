            ...
            <div className="container mx-auto px-6 lg:px-20">
                <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start">
                    ...
                    <div className="mb-6 lg:mb-0 lg:w-1/3">
                        ...
                        <p className="text-sm">
                            Welcome to our school. We are dedicated to providing the best education and nurturing environment for our students.
                        </p>
                    </div>
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <ul className="text-sm">
                            <li className="mb-2">123 School St, City, Country</li>
                ...
                <div className="mt-8 border-t border-blue-600 pt-6 text-center text-sm">
                    © {new Date().getFullYear()} Idea School. All rights reserved.
                </div>
            </div>
        </footer>
    );
